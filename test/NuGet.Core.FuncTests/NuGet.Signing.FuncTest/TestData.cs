...
namespace NuGet.Signing.FuncTest
{
    ...
    {
        internal static void CopyToFile(string resourceName, string filePath)
        {
        ...
        {
            return ResourceTestUtility.GetResourceBytes($"NuGet.Signing.FuncTest.compiler.resources.{resourceName}", typeof(TestData));
        }
    }
}